package com.programmingworld.mak.roommvvmprojects.Room;
...
import com.programmingworld.mak.roommvvmprojects.Room.Dao.BookDAO;
import com.programmingworld.mak.roommvvmprojects.Room.Dao.CategoryDAO;
    ...
    public static  synchronized  BooksDatabase getInstance(Context context){
        if(instance==null){
            Room.databaseBuilder(context.getApplicationContext(),
                    ...
                    //.addMigrations(new RecentUpdate(3,6))
                    .build();
        }
        return instance;
    }

    /*static class RecentUpdate extends Migration{

        public RecentUpdate(int startVersion, int endVersion) {
